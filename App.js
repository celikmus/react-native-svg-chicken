    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={{ color: 'black', fontWeight: '500' }}>
          GitHub <Ionicons color="black" size={24} name="logo-github" />{' '}
          @ggomaeng
        </Text>
        <View style={{ transform: whole }}>
          ...
          <View
            style={{ position: 'absolute', transform: leg, top: 315, left: 80 }}
          >
          ...
          <View
            style={{ position: 'absolute', transform: hair2, top: 8, left: 23 }}
          >
          ...
          <View
            style={{ position: 'absolute', transform: hair, top: 0, left: 70 }}
          >
            <Hair color={colors.red} stroke={colors.dark_red} />
          </View>

          <View
            style={{ position: 'absolute', transform: bag, top: 110, left: 60 }}
          >
            <Bag />
          </View>
          ...
          <View
            style={{ transform: beak, position: 'absolute', top: 95, left: 20 }}
          >
            <Beak />
          </View>
        </View>
