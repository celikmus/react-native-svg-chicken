...
export default class SvgExample extends Component {
  ...
  blink() {
    Animated.sequence([
      Animated.timing(this.state.posY, { toValue: 10, duration: 300 }),

      Animated.delay(100),

      Animated.timing(this.state.posY, { toValue: 0, duration: 300 })
    ]).start(() => {
    ...
    return (
      <Svg height="100" width="100">
        ...
        <Circle
          ...
          fill="white"
        />
        <Path d="M85,45 a5.5,5 0 1,0 -70,0" fill={colors.brown} stroke="none" />
        <Circle
          cx="50"
          cy="55"
          r="10"
